...
namespace framework {
namespace strat { // avoid recursive including
class RcBase;
...
struct TransactionProp {
    ...
    std::string description() const
    {
        return fmt::format(
            ...
            TimeoutMicroseconds, MaxSendTimes, MaxCancelTimes, CancelIntervalMicro, ExposureDeadlineMicroseconds,
            CancelOnTimeout, CloseOnTimeout, TerminateOnRejected, KeepWaitingForLastResponse,
