...
const int TID_TE_RspOrderInsert = 10205; // 订单应答(UFT:提交到柜台接口时立即返回,
...
const int TID_TE_ReqJsonTrading = 10212;    // 发送JSON订单请求
const int TID_TE_RspJsonTrading = 10213;    // JSON订单回复
