...
public:
    ...
    virtual void unsubscribe(int dataType, const std::string& exId, const std::string& insId){};

    virtual ~MarketHandler(){};

protected:
    virtual void onRtnDepthMarketData(int32_t dataType, const char* data, size_t datasiz) PURE;
};
