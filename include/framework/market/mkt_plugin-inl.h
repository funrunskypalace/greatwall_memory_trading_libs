...
template <> struct formatter<framework::MarketPluginId> : fmt::formatter<std::string> {
...
template <> struct formatter<framework::MarketPluginInstId> : fmt::formatter<std::string> {
    auto format(const framework::MarketPluginInstId& s, fmt::format_context& ctx)
    {
        return fmt::formatter<std::string>::format(s.str_value(), ctx);
    }
};
...
namespace std {
extern GWSDK_API ostream& operator<<(ostream& os, const framework::MarketPluginId& v);
extern GWSDK_API ostream& operator<<(ostream& os, const framework::MarketPluginInstId& v);
extern GWSDK_API istream& operator>>(istream& is, framework::MarketPluginId& v);
extern GWSDK_API istream& operator>>(istream& is, framework::MarketPluginInstId& v);
