...
{
public:
    // If this enum is changed, then the std::unordered_map in
    // orchid::Grpc::Utility::nameToGrpcStatus located at:
    // //source/common/common/access_log/grpc/status.cc must also be changed.
    enum GrpcStatus
    {
        ...
        // This is a non-GRPC error code, indicating the status code in gRPC
        // headers
        // was invalid.
        InvalidCode = -1,
    };
