...
public:
    enum class IoErrorCode
    {
        ...
        // During non-blocking connect, the connection cannot be completed
        // immediately.
        InProgress,
        // Permission denied.
        Permission,
        ...
        // Bad file descriptor.
        BadFd,
        // Other error codes cannot be mapped to any one above in
        // getErrorCode().
        UnknownError
    };
 ...
 * If the call succeeds, ok() should return true and |rc_| is valid. Otherwise
 * |err_| can be passed into IoError::getErrorCode() to extract the error. In
 * this case, |rc_| is invalid.
 */
