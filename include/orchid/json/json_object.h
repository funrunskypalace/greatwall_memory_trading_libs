 ...
 */
class Exception : public OrchidException
{
public:
    Exception(const std::string& message) : OrchidException(message) {}
};
...
public:
     ...
     */
    virtual std::vector<ObjectSharedPtr>
    getObjectArray(const std::string& name,
                   bool allow_empty = false) const PURE;
    ...
    getStringArray(const std::string& name,
                   bool allow_empty = false) const PURE;
    ...
    /**
     * @return a hash of the JSON object. This is a hash of each nested element
     * in stable order. It does not consider white space that was originally in
     * the parsed JSON.
     */
     ...
     * @param schema supplies the schema in string format. A Json::Exception
     * will be thrown if the JSON object doesn't conform to the supplied schema
     * or the schema itself is not valid.
     */
    virtual void validateSchema(const std::string& schema) const PURE;

    /**
     * @return the value of the object as a string (where the object is a
     * string).
     */
    ...
    /**
     * @return the value of the object as a double (where the object is a
     * double).
     */
