...
public:
    ...
    /**
     * Inserts a new interval into the set, merging any overlaps. The intervals
     * are in the form [left_inclusive, right_exclusive). E.g. an interval [3,
     * 5) includes the numbers 3 and 4, but not 5.
