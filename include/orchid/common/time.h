...
/**
 * Captures a system-time source, capable of computing both monotonically
 * increasing and real time.
 */
class TimeSource
{
public:
    ...
    /**
     * @return the current system time; not guaranteed to be monotonically
     * increasing.
     */
