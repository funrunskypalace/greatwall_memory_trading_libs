...
namespace cli
{
    ...
    public:
        ...
        void updatePrompt(const std::string& newprompt);
    ...
    public:
        ...
        inline void updatePrompt(const std::string& newprompt)
        {
            updateName(newprompt);
        }
    ...
    inline void CliSession::updatePrompt(const std::string& newprompt)
    {
    }
